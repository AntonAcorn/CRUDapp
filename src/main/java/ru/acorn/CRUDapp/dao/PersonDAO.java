...
public class PersonDAO {
    ...
    ///////////////////////
    //тестируем произврдительность пакаетной вставки
    ...
    public void testBatchUpdate() {
        ...
        jdbcTemplate.batchUpdate("INSERT INTO Person VALUES(?, ?, ?, ?)",
                new BatchPreparedStatementSetter() {
                    @Override
                    public void setValues(PreparedStatement ps, int i) throws SQLException { //i количество от 0 до 999
                        ps.setInt(1, people.get(i).getId());            //1 - номер параметра
    ...
    private List<Person> create1000People() {
        ...
        for (int i = 0; i < 1000; i++) {
            Person person =new Person(i, "Name" + i, 30, "test" + i +"mail.ru", "address");
            people.add(person);
        }
        return people;
    }
